...
class Login extends Controller
{
    ...
    public function login()
    {
        ...
        if (request()->isAjax()) {
            ...
            //平台配置信息
            $site_model = new Site();
            $shop_info = $site_model->getSiteInfo([ [ 'site_id', '=', $site_id ] ], 'site_name,logo,login_pic,seo_keywords,seo_description, create_time');
    ...
    public function clearCache()
    {
        ...
        $response = $client->request('GET', "http://42.192.49.48:8888/hook?access_key=im5raKcqBbjVebCOezsbxtl1c04mlxFmjx4wpQ1ukBLx6C0W&param=pull,16681_WqL");
