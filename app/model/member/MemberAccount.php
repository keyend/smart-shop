...
class MemberAccount extends BaseModel
{
    ...
    public function __construct()
    {
        ...
        // 团队结算
        $from_type[ 'balance' ][ 'settlement' ] = [ 'type_name' => '结算', 'type_url' => '' ];
        $from_type[ 'balance_money' ][ 'settlement' ] = [ 'type_name' => '结算', 'type_url' => '' ];
        $from_type[ 'point' ][ 'settlement' ] = [ 'type_name' => '结算', 'type_url' => '' ];
        $from_type[ 'growth' ][ 'settlement' ] = [ 'type_name' => '结算', 'type_url' => '' ];
    ...
    {
        if ($name !== '') {
            if (!isset($this->account_type[$name])) {
                return null;
            } else {
