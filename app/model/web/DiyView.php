...
class DiyView extends BaseModel
{
    ...
    public function getMemberIndexDiyConfig($site_id)
    {
        ...
        if (empty($res[ 'data' ][ 'value' ])) {
            ...
            if ($membersignin_addon_is_exit) {
                $menuList[] =
                    [
                        'tag' => 'membersignin',
                        "text" => "签到",
                        "img" => "upload/uniapp/member/index/sign.png",
                        "link" => [
                            "name" => "SIGN_IN",
                            "title" => "签到",
            ...
            $menuList[] = [
                "text" => "个人资料",
                "img" => "upload/uniapp/member/index/person.png",
                "link" => [
                    "name" => "MEMBER_INFO",
                    "title" => "个人资料",
            ...
            $menuList[] = [
                "text" => "收货地址",
                "img" => "upload/uniapp/member/index/address.png",
                "link" => [
            ...
            if ($memberwithdraw_addon_is_exit) {
                $menuList[] = [
                    'tag' => 'memberwithdraw',
                    "text" => "账户列表",
                    "img" => "upload/uniapp/member/index/cash.png",
                    "link" => [
                        "name" => "ACCOUNT",
                        "title" => "账户列表",
            ...
            if ($coupon_addon_is_exit) {
                $menuList[] = [
                    'tag' => 'coupon',
                    "text" => "优惠券",
                    "img" => "upload/uniapp/member/index/discount.png",
                    "link" => [
                        "name" => "COUPON",
                        "title" => "优惠券",
            ...
            if ($pintuan_addon_is_exit) {
                $menuList[] = [
                    'tag' => 'pintuan',
                    "text" => "我的拼单",
                    "img" => "upload/uniapp/member/index/store.png",
                    "link" => [
                        "name" => "MY_PINTUAN",
                        "title" => "我的拼团",
            ...
            $menuList[] = [
                "text" => "我的关注",
                "img" => "upload/uniapp/member/index/like.png",
                "link" => [
                    "name" => "ATTENTION",
                    "title" => "我的关注",
            ...
            $menuList[] = [
                "text" => "我的足迹",
                "img" => "upload/uniapp/member/index/toot.png",
                "link" => [
                    "name" => "FOOTPRINT",
                    "title" => "我的足迹",
            ...
            if ($pointexchange_addon_is_exit) {
                $menuList[] = [
                    'tag' => 'pointexchange',
                    "text" => "积分兑换",
                    "img" => "upload/uniapp/member/index/point_recond.png",
                    "link" => [
            ...
            $menuList[] = [
                'tag' => 'verifier',
                "text" => "核销台",
                "img" => "upload/uniapp/member/index/verification.png",
                "link" => [
            ...
            if ($fenxiao_addon_is_exit) {
                $menuList[] = [
                    'tag' => 'fenxiao',
                    "text" => "分销中心",
                    "img" => "upload/uniapp/member/index/fenxiao.png",
                    "link" => [
            ...
            if ($bargain_addon_is_exit) {
                $menuList[] = [
                    'tag' => 'bargain',
                    "text" => "我的砍价",
                    "img" => "upload/uniapp/member/index/bargain.png",
                    "link" => [
                        "name" => "MY_BARGAIN",
                        "title" => "我的砍价",
