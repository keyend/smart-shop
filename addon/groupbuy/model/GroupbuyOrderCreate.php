...
//        Cache::tag("order_create_groupbuy_".$data['member_id'])->set("order_create_groupbuy_".$data['id'].'_'.$data['num'].'_'.$data['member_id'], $shop_goods_list, 600);
    ...
    {
        //组装商品列表
        $field = 'ngs.sku_id,ngs.sku_name, ngs.sku_no,ngs.price, ngs.discount_price, ngs.cost_price, ngs.stock, ngs.weight, ngs.volume, ngs.sku_image, ngs.site_id, ngs.goods_state, ngs.is_virtual, 
        ngs.is_free_shipping, ngs.shipping_template, ngs.goods_class, ngs.goods_class_name,ngs.goods_id, ns.site_name,ngs.sku_spec_format,ngs.goods_name,g.goods_image';
        $join = [
            [
                'site ns',
