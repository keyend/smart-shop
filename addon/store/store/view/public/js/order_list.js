...
Order.prototype.cols = [
	{
		...
		template: function (orderitem, order) {
			...
			if (orderitem.refund_status_name != '') {
				h += '<br/><a href="' + ns.url("store://store/orderrefund/detail", {order_goods_id: orderitem.order_goods_id}) + '"  target="_blank" class="ns-text-color">' + orderitem.refund_status_name + '</a>&nbsp;&nbsp;';
			}
			return h;
		}
	},
