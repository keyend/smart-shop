...
var bargainTopHtml = '<ul class="fenxiao-addon-title">';
		bargainTopHtml += '<li>';
			...
			bargainTopHtml += '<div class="layui-form-item">';
				...
				bargainTopHtml += '</div>';
				bargainTopHtml += '<div class="ns-word-aux ns-diy-word-aux">建议上传图标大小：20px * 20px</div>';
			bargainTopHtml += '</div>';
			...
			bargainTopHtml += '<color v-bind:data="{ field : \'titleTextColor\', label : \'标题颜色\', defaultcolor: \'#000\' }"></color>';
		bargainTopHtml += '</li>';
		...
		bargainTopHtml += '<li>';
			...
			bargainTopHtml += '<div class="content-block">';
				bargainTopHtml += '<div class="layui-form-item">';
					...
					bargainTopHtml += '</div>';
				bargainTopHtml += '</div>';
				bargainTopHtml += '<color v-bind:data="{ field : \'moreTextColor\', defaultcolor: \'#858585\' }"></color>';
