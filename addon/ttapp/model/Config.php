...
class Config extends BaseModel
{
    ...
    public function setConfig($data, $is_use, $site_id = 0)
    {
        ...
        $res    = $config->setConfig($data, '字节小程序设置', $is_use, [['site_id', '=', $site_id], ['app_module', '=', 'shop'], ['config_key', '=', 'TTAPP_CONFIG']]);
        return $res;
    }
    /**
     * 获取小程序配置信息
    ...
    {
        $config = new ConfigModel();
        $res    = $config->setConfig($data, '字节小程序版本', $is_use, [['site_id', '=', $site_id], ['app_module', '=', 'shop'], ['config_key', '=', 'TTAPP_VERSION']]);
        return $res;
    }
    /**
     * 获取小程序版本信息
    ...
    public function setShareConfig($site_id, $app_module, $key, $value){
        ...
        $res = $model->setConfig($data, '字节小程序分享', 1, [['site_id', '=', $site_id], ['app_module', '=', $app_module], ['config_key', '=', 'TTAPP_SHARE']]);
        return $res;
    }
    /**
     * 获取小程序分享配置
