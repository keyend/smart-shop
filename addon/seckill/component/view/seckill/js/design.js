...
var seckillTopConHtml = '<div class="goods-head">';
	...
	seckillTopConHtml +=		'<span v-bind:style="{color: data.moreTextColor?data.moreTextColor:\'rgba(0,0,0,0)\'}">{{listMore.title}}</span>';
...
var seckillTopHtml = '<ul class="fenxiao-addon-title">';
		seckillTopHtml += '<li>';
			...
			seckillTopHtml += '<div class="layui-form-item">';
				...
				seckillTopHtml += '</div>';
				seckillTopHtml += '<div class="ns-word-aux ns-diy-word-aux">建议上传图标大小：20px * 20px</div>';
			seckillTopHtml += '</div>';
