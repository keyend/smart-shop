...
class Idnumber
{
     ...
     * 第18位校检码
     */
    public static $verifyCode = array(
        "1",
        "0",
        "X",
        "9",
    ...
    public static $province = array(
      ...
      '519003' => '四川省都江堰市',
      '519004' => '四川省峨眉山市',
      '652400' => '新疆维吾尔自治区伊犁哈萨克自治州',
      '652401' => '新疆维吾尔自治区伊犁哈萨克自治州伊宁市',
      '652402' => '新疆维吾尔自治区伊犁哈萨克自治州奎屯市',
      '652420' => '新疆维吾尔自治区伊犁哈萨克自治州伊宁县',
      '652421' => '新疆维吾尔自治区伊犁哈萨克自治州察布查尔锡伯自治县',
      '652422' => '新疆维吾尔自治区伊犁哈萨克自治州霍城县',
      '652423' => '新疆维吾尔自治区伊犁哈萨克自治州巩留县',
      '652424' => '新疆维吾尔自治区伊犁哈萨克自治州新源县',
      '652425' => '新疆维吾尔自治区伊犁哈萨克自治州昭苏县',
      '652426' => '新疆维吾尔自治区伊犁哈萨克自治州特克斯县',
      '652427' => '新疆维吾尔自治区伊犁哈萨克自治州尼勒克县',
      '339000' => '浙江省',
      '339001' => '浙江省余姚市',
      '339002' => '浙江省海宁市',
      '339003' => '浙江省兰溪市',
     ...
     * @var array
     */
    public static $twFirstCode = array(
        'A' => 10,
        'B' => 11,
        'C' => 12,
        'D' => 13,
     ...
     * 香港身份证校验
     */
    public static $hkFirstCode = array(
        'A' => 1,
        'B' => 2,
        'C' => 3,
        'R' => 18,
    ...
    public static function validateIdCard10($idCard) {
        ...
        if (0 < preg_match("/^[a-zA-Z][0-9]{9}$/", $idCard)) {
            // 台湾
            $info[0] = "台湾";
        ...
        } else if (0 < preg_match("/^[1|5|7][0-9]{6}\(?[0-9A-Z]\)?$/", $idCard)) {
            // 澳门
            $info[0] = "澳门";
            $info[1] = "N";
            // TODO
            
        } else if (0 < preg_match("/^[A-Z]{1,2}[0-9]{6}\(?[0-9A]\)?$/", $idCard)) {
            // 香港
            $info[0] = "香港";
            $info[1] = "N";
     ...
     *
     * @param string  $idCard 身份编号
     * @param integer $patch  取日期时间,0日,1月,2年,3年,月,日
     * @return NULL string
     */
    public static function getDateByIdCard($idCard, $patch=0) {
        $len = strlen($idCard);
        ...
        if ($patch === 0) {
          ...
          $arr = [];
          $arr['day'] = substr($idCard, 12, 2);
          $arr['month'] = substr($idCard, 10, 2);
          $arr['year'] = substr($idCard, 6, 4);
